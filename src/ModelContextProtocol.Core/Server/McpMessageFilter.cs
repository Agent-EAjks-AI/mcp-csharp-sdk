...
/// <summary>
/// Delegate type for applying filters to incoming JSON-RPC messages.
/// </summary>
...
/// <remarks>
/// <para>
/// Message filters allow you to intercept and process all incoming JSON-RPC messages before they reach
/// their respective handlers. This is useful for implementing cross-cutting concerns that need to apply
/// to all message types, such as logging, authentication, rate limiting, or request tracing.
/// </para>
/// <para>
